...
# ///
"""
Pretty missing-data matrix for RNA-Seq, inspired by missingno.

Usage:
    from pretty_missing import missing_matrix

    # df: genes (rows) x samples (MultiIndex columns), NaN = missing
    fig = missing_matrix(df, title="My QC Plot", save="output.png")

    # Interactive HTML version
    missing_matrix_html(df, title="My QC Plot", save="output.html")
"""
